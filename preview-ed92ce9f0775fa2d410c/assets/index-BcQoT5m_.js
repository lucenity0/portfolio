(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=t(i);fetch(i.href,s)}})();class Re{map=new Map;register(e){this.map.set(e.name.toLowerCase(),e)}registerAll(e){for(const t of e)this.register(t)}get(e){return this.map.get(e.toLowerCase())}all(){return[...this.map.values()]}visible(){return this.all().filter(e=>!e.hidden)}names(){return[...this.map.keys()]}}const $e=["n","s","e","w","ne","nw","se","sw"];function ze(o){const e=document.createElement("section");e.className="window brackets is-opening",e.setAttribute("role","dialog"),e.setAttribute("aria-label",o);const t=document.createElement("header");t.className="window__bar";const n=document.createElement("span");n.className="window__dots";const i=document.createElement("span");i.className="window__dot";const s=document.createElement("span");s.className="window__dot";const a=document.createElement("span");a.className="window__dot",n.append(i,s,a);const r=document.createElement("span");r.className="window__title",r.textContent=o;const c=document.createElement("span");c.className="window__controls";const l=document.createElement("button");l.className="window__btn window__btn--min",l.type="button",l.title="minimize",l.setAttribute("aria-label","minimize window"),l.textContent="–";const d=document.createElement("button");d.className="window__btn window__btn--max",d.type="button",d.title="maximize",d.setAttribute("aria-label","maximize window"),d.textContent="□";const f=document.createElement("button");f.className="window__btn window__btn--close",f.type="button",f.title="close",f.setAttribute("aria-label","close window"),f.textContent="×",c.append(l,d,f),t.append(n,r,c);const b=document.createElement("div");b.className="window__body",e.append(t,b);const _=$e.map(v=>{const h=document.createElement("span");return h.className=`window__resize window__resize--${v}`,h.dataset.dir=v,e.append(h),h});return{el:e,barEl:t,bodyEl:b,closeBtn:f,minimizeBtn:l,maximizeBtn:d,resizeHandles:_}}class Oe{root;folderBtn;countEl;listEl;items=new Map;open=!1;constructor(e){this.root=document.createElement("div"),this.root.className="tray",this.root.hidden=!0,this.folderBtn=document.createElement("button"),this.folderBtn.className="tray__folder",this.folderBtn.type="button",this.folderBtn.setAttribute("aria-label","minimized windows"),this.folderBtn.setAttribute("aria-haspopup","true"),this.folderBtn.setAttribute("aria-expanded","false"),this.folderBtn.innerHTML='<span class="tray__glyph" aria-hidden="true">▚</span><span class="tray__count">0</span>',this.countEl=this.folderBtn.querySelector(".tray__count"),this.listEl=document.createElement("div"),this.listEl.className="tray__list",this.listEl.hidden=!0,this.folderBtn.addEventListener("click",()=>this.toggle()),this.root.append(this.folderBtn,this.listEl),e.append(this.root)}add(e,t,n){this.items.set(e,{title:t,onRestore:n}),this.render()}remove(e){this.items.delete(e),this.items.size===0&&(this.open=!1),this.render()}has(e){return this.items.has(e)}toggle(){this.open=!this.open&&this.items.size>0,this.render()}render(){const e=this.items.size;this.root.hidden=e===0,this.countEl.textContent=String(e),this.listEl.hidden=!this.open||e===0,this.folderBtn.classList.toggle("is-open",this.open),this.folderBtn.setAttribute("aria-expanded",String(this.open&&e>0)),this.listEl.replaceChildren();for(const[t,n]of this.items){const i=document.createElement("button");i.className="tray__item",i.type="button",i.textContent=n.title,i.addEventListener("click",()=>{n.onRestore(),this.open=!1,this.render()}),this.listEl.append(i)}}}const M=()=>window.matchMedia("(prefers-reduced-motion: reduce)").matches,P=o=>new Promise(e=>window.setTimeout(e,o));async function te(o,e,t={}){const{speed:n=18,delay:i=0}=t;if(M()){o.textContent=e;return}i>0&&await P(i),o.textContent="";for(const s of e)o.textContent+=s,await P(n)}function U(o,e){M()||(o.classList.add(e),o.addEventListener("animationend",()=>o.classList.remove(e),{once:!0}))}const oe=["⠋","⠙","⠹","⠸","⠼","⠴","⠦","⠧","⠇","⠏"];function we(o,e){const t=performance.now();let n=null;if(M())o.textContent=`${e}…`;else{let i=0;const s=()=>{const a=oe[i%oe.length],r=".".repeat((i>>2)%4);o.textContent=`${a} ${e}${r}`,i++};s(),n=window.setInterval(s,90)}return{stop(){return n!==null&&window.clearInterval(n),(performance.now()-t)/1e3}}}const ae={width:420,height:300},F=260,$=160,T=8,q=16,I=12;class Be{root;tray;records=new Map;minimized=new Set;mru=[];topZ=100;spawnCount=0;area={w:0,h:0};ro;constructor(e){this.root=e,this.tray=new Oe(e),this.ro=new ResizeObserver(()=>this.remeasure()),this.ro.observe(e),window.addEventListener("resize",()=>this.remeasure()),this.measure()}measure(){const e=parseFloat(getComputedStyle(this.root).getPropertyValue("--desktop-inset-bottom"));this.area={w:this.root.clientWidth,h:Math.max($,this.root.clientHeight-(Number.isFinite(e)?e:0))}}remeasure(){this.measure(),this.reclampAll()}reclampAll(){const{w:e,h:t}=this.area;if(!(e===0||t===0))for(const[n,i]of this.records){if(this.minimized.has(n))continue;const s=i.el;if(s.classList.contains("is-maximized")){s.style.left=`${I}px`,s.style.top=`${I}px`,s.style.width=`${e-I*2}px`,s.style.height=`${t-I*2}px`;continue}const a=Math.min(s.offsetWidth,Math.max(F,e-q)),r=Math.min(s.offsetHeight,Math.max($,t-q));s.style.width=`${a}px`,s.style.height=`${r}px`;const c=Math.min(s.offsetLeft,Math.max(T,e-a-T)),l=Math.min(s.offsetTop,Math.max(T,t-r-T));s.style.left=`${Math.max(0,c)}px`,s.style.top=`${Math.max(0,l)}px`}}open(e){const t=e.singleton??!0,n=this.records.get(e.id);if(t&&n)return this.minimized.has(e.id)?this.restore(e.id):n.instance.focus(),n.instance;const i=ze(e.title),{el:s,bodyEl:a,barEl:r,closeBtn:c,minimizeBtn:l,maximizeBtn:d,resizeHandles:f}=i,{w:b,h:_}=this.area,v=Math.max(F,b-q),h=Math.max($,_-q),p=Math.min(e.width??ae.width,v),g=Math.min(e.height??ae.height,h);s.style.width=`${p}px`,s.style.height=`${g}px`;const k=this.spawnCount++%6*26,u=e.x??Math.max(T,b/2-p/2+k),E=e.y??Math.max(T,_/2-g/2+k);s.style.left=`${Math.min(u,Math.max(T,b-p-T))}px`,s.style.top=`${Math.min(E,Math.max(T,_-g-T))}px`,typeof e.content=="string"?a.textContent=e.content:a.appendChild(e.content);const L={id:e.id,el:s,bodyEl:a,close:()=>this.close(e.id),focus:()=>this.focus(e.id)};return c.addEventListener("click",m=>{m.stopPropagation(),this.close(e.id)}),l.addEventListener("click",m=>{m.stopPropagation(),this.minimize(e.id)}),d.addEventListener("click",m=>{m.stopPropagation(),this.toggleMaximize(e.id)}),r.addEventListener("dblclick",m=>{m.target.closest(".window__dot, .window__btn")||this.toggleMaximize(e.id)}),s.addEventListener("pointerdown",()=>this.focus(e.id)),s.addEventListener("keydown",m=>{m.key!=="Escape"||m.target.closest("input, textarea, select, [contenteditable]")||(m.stopPropagation(),this.close(e.id))}),this.enableDrag(s,r),this.enableResize(e.id,s,f),this.records.set(e.id,{instance:L,el:s,title:e.title}),this.root.appendChild(s),this.focus(e.id),L}close(e){const t=this.records.get(e);if(!t)return;this.records.delete(e);const n=this.minimized.delete(e);if(this.mru=this.mru.filter(i=>i!==e),this.tray.has(e)&&this.tray.remove(e),M()||n){t.el.remove();return}t.el.classList.add("is-closing"),t.el.addEventListener("animationend",()=>t.el.remove(),{once:!0}),window.setTimeout(()=>t.el.remove(),600)}toggleMaximize(e){const t=this.records.get(e);if(!t||this.minimized.has(e))return;if(M()||(t.el.classList.add("is-snapping"),window.setTimeout(()=>t.el.classList.remove("is-snapping"),300)),t.savedRect){const i=t.savedRect;t.el.style.left=i.left,t.el.style.top=i.top,t.el.style.width=i.width,t.el.style.height=i.height,delete t.savedRect,t.el.classList.remove("is-maximized")}else t.savedRect={left:t.el.style.left,top:t.el.style.top,width:t.el.style.width,height:t.el.style.height},t.el.style.left=`${I}px`,t.el.style.top=`${I}px`,t.el.style.width=`${this.area.w-I*2}px`,t.el.style.height=`${this.area.h-I*2}px`,t.el.classList.add("is-maximized");const n=t.el.querySelector(".window__btn--max");if(n){const i=t.el.classList.contains("is-maximized");n.textContent=i?"❐":"□",n.title=i?"restore":"maximize",n.setAttribute("aria-label",i?"restore window":"maximize window")}this.focus(e)}focus(e){const t=this.records.get(e);if(t){for(const[n,i]of this.records)i.el.classList.toggle("is-active",n===e&&!this.minimized.has(n));t.el.style.zIndex=String(++this.topZ),this.mru=[e,...this.mru.filter(n=>n!==e)]}}cycle(e){const t=this.mru.filter(i=>this.records.has(i)&&!this.minimized.has(i));if(t.length<2)return;const n=e===1?t[1]:t[t.length-1];n&&this.focus(n)}get(e){return this.records.get(e)?.instance}minimize(e){const t=this.records.get(e);if(!(!t||this.minimized.has(e))){if(this.minimized.add(e),t.el.classList.remove("is-active"),this.tray.add(e,t.title,()=>this.restore(e)),M()){t.el.style.display="none";return}t.el.classList.add("is-minimizing"),t.el.addEventListener("animationend",()=>{t.el.style.display="none",t.el.classList.remove("is-minimizing")},{once:!0})}}list(){return[...this.records.entries()].map(([e,t])=>({id:e,title:t.el.querySelector(".window__title")?.textContent??e,el:t.el,minimized:this.minimized.has(e)}))}restore(e){const t=this.records.get(e);t&&(this.minimized.delete(e),this.tray.has(e)&&this.tray.remove(e),t.el.style.display="",t.el.classList.remove("is-minimizing"),this.focus(e),U(t.el,"is-opening"))}enableDrag(e,t){let n=0,i=0,s=0,a=0,r=!1;const c=d=>{if(!r)return;const f=s+(d.clientX-n),b=a+(d.clientY-i);e.style.left=`${Math.min(Math.max(f,-e.clientWidth+80),this.area.w-80)}px`,e.style.top=`${Math.min(Math.max(b,0),this.area.h-40)}px`},l=d=>{r=!1,t.releasePointerCapture?.(d.pointerId),window.removeEventListener("pointermove",c),window.removeEventListener("pointerup",l)};t.addEventListener("pointerdown",d=>{d.target.closest(".window__btn")||e.classList.contains("is-maximized")||(this.measure(),r=!0,n=d.clientX,i=d.clientY,s=e.offsetLeft,a=e.offsetTop,t.setPointerCapture?.(d.pointerId),window.addEventListener("pointermove",c),window.addEventListener("pointerup",l))})}enableResize(e,t,n){for(const i of n)i.addEventListener("pointerdown",s=>{if(s.preventDefault(),s.stopPropagation(),t.classList.contains("is-maximized"))return;this.focus(e),this.measure();const a=i.dataset.dir??"se",r=s.clientX,c=s.clientY,l=t.offsetLeft,d=t.offsetTop,f=t.offsetWidth,b=t.offsetHeight,{w:_,h:v}=this.area,h=l+f,p=d+b,g=u=>{const E=u.clientX-r,L=u.clientY-c;let m=l,y=d,w=f,C=b;a.includes("e")&&(w=Math.min(Math.max(F,f+E),Math.max(F,_-l-T))),a.includes("s")&&(C=Math.min(Math.max($,b+L),Math.max($,v-d-T))),a.includes("w")&&(m=Math.min(Math.max(0,l+E),h-F),w=h-m),a.includes("n")&&(y=Math.min(Math.max(0,d+L),p-$),C=p-y),t.style.left=`${m}px`,t.style.top=`${y}px`,t.style.width=`${w}px`,t.style.height=`${C}px`},k=u=>{i.releasePointerCapture?.(u.pointerId),window.removeEventListener("pointermove",g),window.removeEventListener("pointerup",k)};i.setPointerCapture?.(s.pointerId),window.addEventListener("pointermove",g),window.addEventListener("pointerup",k)})}}function re(o){const e=[];let t="",n=!1,i=null;for(let s=0;s<o.length;s++){const a=o[s];if(i){a===i?i=null:i==='"'&&a==="\\"&&(o[s+1]==='"'||o[s+1]==="\\")?t+=o[++s]:t+=a;continue}if(a==="\\"&&s+1<o.length){t+=o[++s],n=!0;continue}if(a==='"'||a==="'"){i=a,n=!0;continue}if(/\s/.test(a)){n&&(e.push(t),t="",n=!1);continue}t+=a,n=!0}return n&&e.push(t),e}function Fe(o){const e=[],t={};for(const n of o){const i=/^--([^=\s]+)(?:=(.*))?$/.exec(n);i?t[i[1]]=i[2]!==void 0?i[2]:!0:e.push(n)}return{args:e,flags:t}}const le="visitor@lucenity:~$",be="lucenity:history",ce=200,je={default:"terminal__line",dim:"terminal__line terminal__line--dim",sub:"terminal__line terminal__line--sub"};function Ge(o){if(o.length===0)return"";let e=o[0];for(const t of o.slice(1)){for(;!t.startsWith(e);)e=e.slice(0,-1);if(e==="")break}return e}function He(o,e,t){if(Math.abs(o.length-e.length)>t)return t+1;const n=Array.from({length:o.length+1},()=>new Array(e.length+1).fill(0));for(let i=0;i<=o.length;i++)n[i][0]=i;for(let i=0;i<=e.length;i++)n[0][i]=i;for(let i=1;i<=o.length;i++)for(let s=1;s<=e.length;s++){const a=o[i-1]===e[s-1]?0:1;let r=Math.min(n[i-1][s]+1,n[i][s-1]+1,n[i-1][s-1]+a);i>1&&s>1&&o[i-1]===e[s-2]&&o[i-2]===e[s-1]&&(r=Math.min(r,n[i-2][s-2]+1)),n[i][s]=r}return n[o.length][e.length]}function De(o,e){if(o.length<2)return null;const t=o.length>=6?2:1;let n=null;for(const i of e){const s=He(o,i,t);s<=t&&(!n||s<n.dist)&&(n={name:i,dist:s})}return n?.name??null}function Ue(){try{const o=localStorage.getItem(be);if(!o)return[];const e=JSON.parse(o);return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}catch{return[]}}function We(o){try{localStorage.setItem(be,JSON.stringify(o))}catch{}}class qe{scrollEl;inputRow;inputEl;ghostBefore;caretText;ghostAfter;registry;windows;history=[];historyIndex=0;busy=!1;onTyping;onSend;onClear;constructor(e,t,n){this.registry=t,this.windows=n;const i=document.createElement("div");i.className="terminal";const s=document.createElement("div");s.className="terminal__surface";const a=document.createElement("div");a.className="terminal__scroll",a.setAttribute("role","log"),a.setAttribute("aria-live","polite");const r=document.createElement("div");r.className="terminal__input-row";const c=document.createElement("span");c.className="terminal__prompt",c.textContent=le;const l=document.createElement("span");l.className="terminal__field";const d=document.createElement("span");d.className="terminal__ghost",d.setAttribute("aria-hidden","true");const f=document.createTextNode(""),b=document.createElement("span");b.className="caret";const _=document.createTextNode("");b.append(_);const v=document.createTextNode("");d.append(f,b,v);const h=document.createElement("input");h.className="terminal__input",h.type="text",h.setAttribute("aria-label","terminal input"),h.autocomplete="off",h.autocapitalize="off",h.spellcheck=!1,h.setAttribute("autocorrect","off"),h.setAttribute("enterkeyhint","go"),l.append(d,h),r.append(c,l),a.append(r),s.append(a),i.append(s),e.append(i),this.scrollEl=a,this.inputRow=r,this.inputEl=h,this.ghostBefore=f,this.caretText=_,this.ghostAfter=v,this.history=Ue(),this.historyIndex=this.history.length,h.addEventListener("input",()=>{this.renderGhost(),this.scrollToBottom()}),document.addEventListener("selectionchange",()=>{document.activeElement===this.inputEl&&this.renderGhost()}),h.addEventListener("keyup",()=>this.renderGhost()),h.addEventListener("click",()=>this.renderGhost()),h.addEventListener("keydown",p=>this.onKeydown(p)),s.addEventListener("click",()=>{(window.getSelection()?.toString()??"")===""&&this.focusInput()}),document.addEventListener("keydown",p=>{if(p.ctrlKey&&(p.key==="]"||p.key==="[")){p.preventDefault(),this.windows.cycle(p.key==="]"?1:-1);return}if(this.busy||p.metaKey||p.ctrlKey||p.altKey)return;const g=document.activeElement;g!==this.inputEl&&(g instanceof Element&&g.closest(".window")||(p.key.length===1||p.key==="Backspace"||p.key==="Enter")&&this.focusInput())}),this.renderGhost()}print(e="",t="default"){const n=this.makeLine(t);n.textContent=e,this.insertLine(n)}printEl(e){this.insertLine(e)}clear(){for(const e of[...this.scrollEl.children])e!==this.inputRow&&e.remove();this.onClear?.()}focusInput(){this.inputEl.focus()}async typeLine(e,t="default",n=12){const i=this.makeLine(t);this.insertLine(i),await te(i,e,{speed:n}),this.scrollToBottom()}setBusy(e){this.busy=e,this.inputEl.disabled=e}echoPrompt(e){const t=this.makeLine("default"),n=document.createElement("span");n.className="terminal__prompt",n.textContent=`${le} `,t.append(n,document.createTextNode(e)),this.insertLine(t)}makeLine(e){const t=document.createElement("div");return t.className=je[e],t}insertLine(e){this.scrollEl.insertBefore(e,this.inputRow),this.scrollToBottom()}scrollToBottom(){this.scrollEl.scrollTop=this.scrollEl.scrollHeight}renderGhost(){const e=this.inputEl.value,t=this.inputEl.selectionStart??e.length;this.ghostBefore.textContent=e.slice(0,t),this.caretText.textContent=e[t]??"",this.ghostAfter.textContent=e.slice(t+1),this.onTyping?.(e.length)}onKeydown(e){if(this.busy){e.preventDefault();return}switch(e.key){case"Enter":e.preventDefault(),this.submit(this.inputEl.value);break;case"ArrowUp":e.preventDefault(),this.recallHistory(-1);break;case"ArrowDown":e.preventDefault(),this.recallHistory(1);break;case"Tab":e.preventDefault(),this.handleTab();break;default:e.key==="l"&&e.ctrlKey&&(e.preventDefault(),this.clear())}}pushHistory(e){this.history[this.history.length-1]!==e&&(this.history.push(e),this.history.length>ce&&(this.history=this.history.slice(this.history.length-ce)),We(this.history)),this.historyIndex=this.history.length}recallHistory(e){if(this.history.length===0)return;this.historyIndex=Math.min(Math.max(this.historyIndex+e,0),this.history.length);const t=this.history[this.historyIndex]??"";this.inputEl.value=t,this.inputEl.setSelectionRange(t.length,t.length),this.renderGhost()}handleTab(){const e=this.inputEl.value,t=re(e),n=/\s$/.test(e),i=t.length===0||t.length===1&&!n,s=n?"":t[t.length-1]??"";let a;if(i)a=this.registry.visible().map(l=>l.name);else{const l=this.registry.get(t[0]??"");if(!l?.complete)return;const d=n?t.slice(1):t.slice(1,-1);a=l.complete(d)}const r=a.filter(l=>l.startsWith(s)).sort();if(r.length===0)return;if(r.length===1){const l=r[0],d=i?[]:n?t:t.slice(0,-1);this.setInput([...d,l].join(" ")+" ");return}const c=Ge(r);if(c.length>s.length){const l=i?[]:n?t:t.slice(0,-1);this.setInput([...l,c].join(" "));return}this.print(r.join("  "),"dim")}setInput(e){this.inputEl.value=e,this.inputEl.setSelectionRange(e.length,e.length),this.renderGhost()}async submit(e){const t=e.trim();if(this.echoPrompt(e),this.inputEl.value="",this.renderGhost(),this.onSend?.(),t==="")return;this.pushHistory(t);const n=re(t);if(n.length===0)return;const i=(n[0]??"").replace(/^\//,""),{args:s,flags:a}=Fe(n.slice(1)),r=this.registry.get(i);if(!r){const c=De(i,this.registry.visible().map(l=>l.name));this.print(c?`command not found: ${i} — did you mean \`${c}\`?`:`command not found: ${i} — type \`help\``,"dim");return}this.setBusy(!0);try{await r.run({terminal:this,windows:this.windows,args:s,flags:a,raw:t})}catch(c){const l=c instanceof Error?c.message:String(c);this.print(`error: ${l}`,"dim")}finally{this.setBusy(!1),this.focusInput()}}}const Ve=["┌───────────────────────────┐","│   l u c e n i t y O S     │","│   bios v1.1 — mono/64k    │","└───────────────────────────┘"],Ye=[["● cpu ................ ok","sub",30],["● memory ............. 640k (plenty)","sub",30],["● pixel shaders ...... ok","sub",40],["● crt scanlines ...... flickering nicely","sub",30],["● liffy.service ...... loaded","sub",60],["● cat daemon ......... asleep (do not wake)","sub",120],["mounting /home/visitor ... done","dim",60]];async function Ke(o){o.setBusy(!0);for(const e of Ve)o.print(e,"dim");M()||await P(180);for(const[e,t,n]of Ye)await o.typeLine(e,t,6),M()||await P(n);o.print(),o.print("welcome. type `help` to see what i can do.","default"),o.print(),o.setBusy(!1),o.focusInput()}const H=["..#.......#...............",".###.....###..............",".#.##....#.##.............",".#..##..##..##............",".#.########..##...........",".################.........",".#################........",".##################.......",".##################.......","###################.......","###################.#####.","##...####...##############","##########################","####################...###",".################.........","..#############..........."],Je={sleep:{},awake:{10:"##..#####..########.#####.",11:"##..#####..###############"},think:{10:"##########.########.#####.",11:"##..####..################"},"munch-a":{12:"#####...##################"},"munch-b":{12:"######..##################"},peek:{10:"##..###############.#####.",11:"##..#####...##############"}};function ve(o="sleep"){const e=Je[o];return H.map((t,n)=>e[n]??t).map(t=>[...t].map(n=>n==="#"?"██":"  ").join("")).join(`
`)}function Qe(o,e){const t=o.querySelector(".cat__art");t&&(t.textContent=ve(e)),o.dataset.frame=e}function ne(o="cat",e="sleep"){const t=document.createElement("div");t.className=o,t.dataset.frame=e;const n=document.createElement("pre");n.className="cat__art",n.textContent=ve(e),n.setAttribute("aria-hidden","true");const i=document.createElement("span");i.className="cat__zzz",i.setAttribute("aria-hidden","true");for(let s=0;s<3;s++){const a=document.createElement("span");a.className="cat__z",a.textContent="z",a.style.animationDelay=`${s*.9}s`,i.append(a)}return t.addEventListener("dragstart",s=>s.preventDefault()),t.append(i,n),t}const Xe=24,Ze=3,et=2e3,de=["quiet!","let me sleep!"],tt=1e3,nt=3e3,he=5,ue=260,it=45e3,st=1e5,ot=6e4,at=15e3,rt=2e4,lt=4500,ct=["zzz... sudo... nice try... zzz","mrrp... a command... named after me...","zzz... git clone... take one home...","...ctrl+] ... windows go round... zzz","zzz... liffy keeps secrets too...","...feed me... 24 keys... zzz"],dt=["mrrp... say meow... i dare you...","zzz... cookie... just type it...","...hold me... one whole second... prrr","zzz... stare at me... see what happens..."];class ke{el;catEl;fillEl;meterEl;plateEl;bubbleEl;opts;cornered=!1;munching=!1;thinking=!1;bobbing=!1;staring=!1;petting=!1;clickTimes=[];bubbleTimer=null;petTimer=null;hoverTimer=null;murmurs;murmurIdx=0;lastActivity=performance.now();constructor(e){this.opts=e,this.el=document.createElement("div"),this.el.className=`catc catc--${e.mode}`,this.el.dataset.frame=e.idleFrame,this.catEl=ne("cat catc__cat",e.idleFrame),this.bubbleEl=document.createElement("span"),this.bubbleEl.className="catc__bubble",this.bubbleEl.setAttribute("role","status"),this.meterEl=document.createElement("div"),this.meterEl.className="catc__meter",this.fillEl=document.createElement("div"),this.fillEl.className="catc__fill",this.plateEl=document.createElement("button"),this.plateEl.className="catc__plate",this.plateEl.type="button",this.plateEl.title="feed the cat",this.plateEl.setAttribute("aria-label","feed the cat a cookie"),this.meterEl.append(this.fillEl,this.plateEl),this.el.append(this.bubbleEl,this.catEl,this.meterEl),e.mount.append(this.el),this.wireAngryClicks(),e.mode==="liffy"&&(this.wirePetHold(),this.wireStareHover()),this.plateEl.addEventListener("click",t=>{t.stopPropagation(),this.feed()}),this.murmurs=[...e.mode==="hero"?ct:dt].sort(()=>Math.random()-.5),this.scheduleMurmur(it)}onTyping(e){e>0&&(this.lastActivity=performance.now()),e>0&&!this.cornered&&this.corner();const t=Math.min(e/Xe,1);this.fillEl.style.width=`${t*100}%`,this.el.classList.toggle("catc--typing",e>0||this.munching),this.plateEl.classList.toggle("is-served",t>=1)}onSend(){this.lastActivity=performance.now(),this.fillEl.style.width="0%",this.plateEl.classList.remove("is-served"),this.munching||this.el.classList.remove("catc--typing")}fillNow(){this.cornered||this.corner(),this.fillEl.style.width="100%",this.el.classList.add("catc--typing"),this.plateEl.classList.add("is-served")}corner(){this.cornered=!0,this.el.classList.add("catc--corner"),this.setFrame("sleep"),this.opts.onCorner?.()}restoreCenter(){this.cornered=!1,this.el.classList.remove("catc--corner"),this.onSend(),this.setFrame(this.opts.idleFrame)}feed(){if(this.munching)return;if(this.munching=!0,this.plateEl.classList.remove("is-served"),this.fillEl.style.width="0%",M()){this.setFrame("munch-a"),this.say("nom.",900),window.setTimeout(()=>{this.munching=!1,this.setFrame(this.restFrame()),this.el.classList.remove("catc--typing")},900);return}this.say("nom nom nom",he*ue+300);let e=0;const t=window.setInterval(()=>{this.setFrame(e%2===0?"munch-a":"munch-b"),e++,e>he&&(window.clearInterval(t),this.munching=!1,this.setFrame(this.restFrame()),this.el.classList.remove("catc--typing"))},ue)}think(e){this.thinking=e,!this.munching&&this.setFrame(e?"think":this.restFrame())}bob(e){this.bobbing=e,e?(this.munching||this.setFrame("awake"),M()||this.el.classList.add("catc--bob")):(this.el.classList.remove("catc--bob"),!this.munching&&!this.thinking&&this.setFrame(this.restFrame()))}hop(){U(this.el,"catc--hop")}say(e,t=2e3){this.bubbleTimer!==null&&window.clearTimeout(this.bubbleTimer),this.bubbleEl.textContent=e,this.bubbleEl.classList.add("is-visible"),this.bubbleTimer=window.setTimeout(()=>{this.bubbleEl.classList.remove("is-visible"),this.bubbleTimer=null},t)}scheduleMurmur(e){window.setTimeout(()=>this.tryMurmur(),e)}tryMurmur(){if(!this.el.isConnected)return;if(this.munching||this.thinking||this.bobbing||this.petting||this.bubbleTimer!==null||document.hidden||performance.now()-this.lastActivity<rt){this.scheduleMurmur(at);return}this.say(this.murmurs[this.murmurIdx++%this.murmurs.length],lt),this.scheduleMurmur(st+Math.random()*ot)}restFrame(){return this.cornered?"sleep":this.opts.idleFrame}setFrame(e){Qe(this.catEl,e),this.el.dataset.frame=e}wireAngryClicks(){this.catEl.addEventListener("click",()=>{if(this.petting)return;const e=performance.now();this.clickTimes=this.clickTimes.filter(t=>e-t<et),this.clickTimes.push(e),this.clickTimes.length>=Ze&&(this.clickTimes=[],U(this.el,"catc--shake"),this.say(de[Math.floor(Math.random()*de.length)],2e3))})}wirePetHold(){this.catEl.addEventListener("pointerdown",()=>{this.petTimer=window.setTimeout(()=>{this.petting=!0,this.el.classList.add("catc--pet"),this.say("prrrrr.",6e4)},tt)});const e=()=>{this.petTimer!==null&&window.clearTimeout(this.petTimer),this.petTimer=null,this.petting&&(this.el.classList.remove("catc--pet"),this.bubbleEl.classList.remove("is-visible"),window.setTimeout(()=>{this.petting=!1},0))};this.catEl.addEventListener("pointerup",e),this.catEl.addEventListener("pointerleave",e)}wireStareHover(){this.catEl.addEventListener("mouseenter",()=>{this.hoverTimer=window.setTimeout(()=>{!this.munching&&!this.thinking&&!this.bobbing&&(this.staring=!0,this.setFrame("peek"))},nt)}),this.catEl.addEventListener("mouseleave",()=>{this.hoverTimer!==null&&window.clearTimeout(this.hoverTimer),this.hoverTimer=null,this.staring&&(this.staring=!1,this.setFrame(this.restFrame()))})}}const me=["hello, stranger!","oh, you're back.","shh. the cat sleeps.","type something. anything."];function ht(o){const e=document.createElement("div");e.className="hero",e.setAttribute("aria-hidden","true");const t=document.createElement("div");t.className="hero__title";const n=document.createElement("span"),i=document.createElement("span");i.className="caret hero__caret",t.append(n,i);const s=document.createElement("div");s.className="hero__sub",s.textContent="do not wake the cat. type instead.",e.append(t,s),o.append(e);const a=new ke({mount:o,mode:"hero",idleFrame:"sleep",onCorner:()=>e.classList.add("hero--hidden")}),r=me[Math.floor(Math.random()*me.length)];return(async()=>(U(e,"is-arriving"),U(a.el,"is-arriving"),M()||await P(350),await te(n,r,{speed:55}),M()||await P(250),s.classList.add("is-visible")))(),{companion:a,restore(){e.classList.remove("hero--hidden"),a.restoreCenter()}}}const pe="lucenity-shell-mode";class ut{mode;listeners=[];toggleBtn;constructor(){const e=localStorage.getItem(pe);this.mode=e==="gui"?"gui":"tty",this.toggleBtn=document.createElement("button"),this.toggleBtn.type="button",this.toggleBtn.className="mode-toggle",this.toggleBtn.addEventListener("click",()=>{this.set(this.mode==="tty"?"gui":"tty")}),document.body.append(this.toggleBtn),this.apply(!1)}get current(){return this.mode}set(e){if(e!==this.mode){this.mode=e,localStorage.setItem(pe,e),this.apply(!0);for(const t of this.listeners)t(e)}}onChange(e){this.listeners.push(e)}apply(e){if(document.body.classList.toggle("mode-gui",this.mode==="gui"),this.toggleBtn.textContent=this.mode==="tty"?"[ gui ]":"[ terminal ]",this.toggleBtn.title=this.mode==="tty"?"switch to the GUI desktop":"switch back to the terminal",this.toggleBtn.setAttribute("aria-pressed",String(this.mode==="gui")),e&&this.mode==="gui"&&!M()){const t=document.querySelector(".rig__screen");t&&(t.classList.remove("is-powering"),t.offsetWidth,t.classList.add("is-powering"),t.addEventListener("animationend",()=>t.classList.remove("is-powering"),{once:!0}))}}}const mt=.75;function pt(){const o=document.documentElement,e=window.visualViewport;let t=0;const n=()=>{const s=e?.height??window.innerHeight,a=e?.offsetTop??0;o.style.setProperty("--vv-height",`${s}px`),o.style.setProperty("--vv-top",`${a}px`),document.body.classList.toggle("is-keyboard-open",s<window.innerHeight*mt)},i=()=>{cancelAnimationFrame(t),t=requestAnimationFrame(n)};return e&&(e.addEventListener("resize",i),e.addEventListener("scroll",i)),window.addEventListener("resize",i),window.addEventListener("orientationchange",i),n(),()=>{cancelAnimationFrame(t),e&&(e.removeEventListener("resize",i),e.removeEventListener("scroll",i)),window.removeEventListener("resize",i),window.removeEventListener("orientationchange",i)}}const ie=o=>o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function ft(o){let e=ie(o);return e=e.replace(/\[([^\]]+)\]\(([^)\s]+)\)/g,(t,n,i)=>`<a href="${i}" target="_blank" rel="noreferrer noopener">${n}</a>`),e=e.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/__([^_]+)__/g,"<strong>$1</strong>"),e=e.replace(/(^|[^*])\*([^*\s][^*]*)\*/g,"$1<em>$2</em>"),e=e.replace(/(^|[^_])_([^_\s][^_]*)_/g,"$1<em>$2</em>"),e}function V(o){return o.split(/(`[^`]+`)/g).map(e=>e.length>=2&&e.startsWith("`")&&e.endsWith("`")?`<code>${ie(e.slice(1,-1))}</code>`:ft(e)).join("")}function gt(o){return o.replace(/```[^\n]*\n?/g,"").replace(/`([^`]+)`/g,"$1").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/__([^_]+)__/g,"$1").replace(/\*([^*]+)\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/^#{1,6}\s+/gm,"").replace(/^\s*[-*+]\s+/gm,"• ").replace(/^>\s?/gm,"").replace(/\n{3,}/g,`

`).trim()}const Y=/^(\s*)([-*+]|\d+\.)\s+(.*)$/;function Ee(o){const e=o.replace(/\r\n?/g,`
`).split(`
`),t=[];let n=0;for(;n<e.length;){const i=e[n];if(/^```/.test(i.trim())){const r=i.trim().slice(0,3);n++;const c=[];for(;n<e.length&&!e[n].trim().startsWith(r);)c.push(e[n]),n++;n++,t.push(`<pre class="md-pre"><code>${ie(c.join(`
`))}</code></pre>`);continue}if(i.trim()===""){n++;continue}const s=/^(#{1,6})\s+(.*)$/.exec(i);if(s){const r=s[1].length;t.push(`<h${r}>${V(s[2].trim())}</h${r}>`),n++;continue}if(/^(-{3,}|\*{3,}|_{3,})\s*$/.test(i.trim())){t.push("<hr />"),n++;continue}if(/^>\s?/.test(i)){const r=[];for(;n<e.length&&/^>\s?/.test(e[n]);)r.push(e[n].replace(/^>\s?/,"")),n++;t.push(`<blockquote>${V(r.join(" "))}</blockquote>`);continue}if(Y.test(i)){const c=/^\s*\d+\./.test(i)?"ol":"ul",l=[];for(;n<e.length&&Y.test(e[n]);){const d=Y.exec(e[n]);l.push(`<li>${V(d[3])}</li>`),n++}t.push(`<${c}>${l.join("")}</${c}>`);continue}const a=[];for(;n<e.length&&e[n].trim()!==""&&!/^```/.test(e[n].trim())&&!/^#{1,6}\s/.test(e[n])&&!/^>\s?/.test(e[n])&&!Y.test(e[n])&&!/^(-{3,}|\*{3,}|_{3,})\s*$/.test(e[n].trim());)a.push(e[n]),n++;t.push(`<p>${V(a.join(" "))}</p>`)}return t.join(`
`)}const yt=`# Nafees S
...
- Type \`contact\` for the rest, or \`liffy\` to just ask me things.`;function _e(o){const e=document.createElement("div");e.className="docs",e.innerHTML=Ee(yt),e.prepend(ne("cat docs__avatar")),o.windows.open({id:"about",title:"about — nafees",content:e,width:540,height:460}),o.terminal.print("opened: about","dim")}function Se(o){const e=document.createElement("div");e.className="contact",e.innerHTML=`
    <h2>contact</h2>
  ...
  `;const n=document.createElement("a");return n.className="project__open",n.href=o.url,n.target="_blank",n.rel="noreferrer noopener",n.textContent="open in new tab ↗",t.append(n),e.append(t),e}function Et(){const o=new Set;for(const e of A)for(const t of e.tags??[])t!=="placeholder"&&o.add(t);return[...o].sort()}function _t(o,e){const t=document.createElement("button");t.className="pgrid__card",t.type="button";const n=document.createElement("span");n.className="pgrid__thumb",n.setAttribute("aria-hidden","true");const i=document.createElement("span");i.className="pgrid__initial",i.textContent=e.name.slice(0,1).toUpperCase(),n.append(i);const s=document.createElement("strong");s.className="pgrid__name",s.textContent=e.name;const a=document.createElement("span");a.className="pgrid__blurb",a.textContent=e.blurb;const r=document.createElement("span");return r.className="pgrid__meta",r.textContent=[e.kind,...(e.tags??[]).filter(c=>c!=="placeholder"&&c!==e.kind)].join(" · "),t.append(n,s,a,r),t.addEventListener("click",()=>Le(o,e.slug)),t}function xe(o){const e=document.createElement("div");e.className="pgrid";const t=document.createElement("div");t.className="pgrid__filters";const n=document.createElement("div");n.className="pgrid__grid";const i=new Map;for(const l of A)i.set(l,_t(o,l));let s="all";const a=[],r=l=>{s=l;for(const f of a)f.classList.toggle("is-active",f.dataset.tag===l);let d=0;for(const[f,b]of i){const _=l==="all"||(f.tags??[]).includes(l)||f.kind===l;b.hidden=!_,_&&d++}c.hidden=d>0};for(const l of["all",...Et()]){const d=document.createElement("button");d.className="pgrid__chip",d.type="button",d.dataset.tag=l,d.textContent=l,d.addEventListener("click",()=>r(l)),a.push(d),t.append(d)}const c=document.createElement("p");c.className="pgrid__empty muted",c.textContent="nothing tagged that (yet).",c.hidden=!0;for(const l of i.values())n.append(l);e.append(t,n,c),r(s),o.windows.open({id:"projects",title:"projects",content:e,width:560,height:420}),o.terminal.print(`opened: projects (${A.length})`,"dim")}const fe=1.4,ge=.72,St=2.4,Lt=3,K=.75,Ct=1.2,xt=.9,Mt=5,Tt=4,At=3,It=.8,Nt=4,Pt=4,Rt=8,J=new Set(["a","an","the","is","are","was","were","be","been","being","do","does","did","of","to","in","on","for","and","or","but","with","at","by","from","as","it","its","this","that","these","those","i","you","he","she","they","we","me","him","her","them","his","your","my","our","their","what","which","who","whom","how","when","where","why","can","could","would","should","will","shall","have","has","had","about","tell","know","any","some","into","so","u","get","got","give","us","please","hey","im"]),Z=new Set(["work","use","using","make","made","build","built","run","get","got","thing","stuff","look","like","happen","involve","mean","explain","describe","show"]);function Q(o){return o.length<=3?o:o.endsWith("ies")?`${o.slice(0,-3)}y`:o.endsWith("ing")&&o.length>5?o.slice(0,-3):o.endsWith("ed")&&o.length>4?o.slice(0,-2):o.endsWith("s")&&!o.endsWith("ss")?o.slice(0,-1):o}function R(o){return o.toLowerCase().split(/[^a-z0-9+#.]+/).map(e=>e.replace(/^[.]+|[.]+$/g,"")).filter(e=>e.length>1&&!J.has(e)).map(Q).filter(e=>!J.has(e))}const ee=o=>[...new Set(o)];function O(o){return o.toLowerCase().replace(/[^a-z0-9]+/g," ").replace(/\s+/g," ").trim()}const N=o=>` ${o} `;function $t(o,e,t){if(Math.abs(o.length-e.length)>t)return t+1;let n=null,i=Array.from({length:e.length+1},(s,a)=>a);for(let s=1;s<=o.length;s++){const a=[s];let r=s;for(let c=1;c<=e.length;c++){const l=o[s-1]===e[c-1]?0:1;let d=Math.min(i[c]+1,a[c-1]+1,i[c-1]+l);n&&s>1&&c>1&&o[s-1]===e[c-2]&&o[s-2]===e[c-1]&&(d=Math.min(d,n[c-2]+1)),a.push(d),d<r&&(r=d)}if(r>t)return t+1;n=i,i=a}return i[e.length]}const zt=new Set(["about","work","works","fun","intro","bio","apps"]);function Ot(o){return o.includes(" ")?!0:o.length>=5&&!zt.has(o)&&!J.has(o)}function Bt(o,e){const t=N(o),n=e.aliases[0];if(n&&t.includes(N(n))||t.includes(N(e.label)))return!0;for(const i of e.namePhrases)if(i.includes(" ")&&t.includes(N(i)))return!0;return!1}const Me="",Ft=/\b(?:[A-Za-z]\.){2,}|\b(?:prof|dr|mr|mrs|ms|sr|jr|st|vs|etc|fig|no|ph|approx|e\.g|i\.e|a\.m|p\.m)\.|\b[A-Z]\.(?=\s+[A-Z0-9])/gi,jt=o=>o.replace(Ft,e=>e.replace(/\./g,Me)),Gt=o=>o.replace(new RegExp(Me,"g"),".");function Ht(o){const e=[];for(const t of o.split(/\n{2,}/)){const n=jt(t.replace(/\s*\n\s*/g," ").trim());if(n)for(const i of n.split(/(?<=[.!?])\s+(?=[A-Z0-9("'*])/)){const s=Gt(i).trim();s&&e.push({text:s,terms:new Set(R(s))})}}return e}function Dt(o){const e=o[0]??"topic";return e.includes(" ")?o.filter(n=>!n.includes(" ")&&n.length>=3&&!J.has(n)).sort((n,i)=>n.length-i.length)[0]??e:e}function Ut(o){const e=[];let t=!1;for(const n of o.split(`
`)){if(t)if(n.trim()===""||/^#{1,3}\s/.test(n))t=!1;else continue;if(/^\s*todo\b/i.test(n)){t=!0;continue}e.push(n)}return e.join(`
`)}function Wt(o){const t=Ut(o.replace(/\r\n?/g,`
`).replace(/<!--[\s\S]*?-->/g,"")).split(`
`),n=[];let i="",s=[];const a=()=>{i&&s.join("").trim()&&n.push({heading:i,body:s})};for(const r of t){const c=/^#{1,3}\s+(.*)$/.exec(r);c?(a(),i=c[1].trim(),s=[]):i&&s.push(r)}return a(),n.map(({heading:r,body:c})=>{const l=r.split(/\s*[/|]\s*/),d=new Set(l.filter(h=>/!\s*$/.test(h)).flatMap(h=>R(O(h)))),f=ee(l.map(h=>O(h)).filter(Boolean)),b=Ht(gt(c.join(`
`)).trim()),_=new Map;let v=0;for(const h of b)for(const p of R(h.text))_.set(p,(_.get(p)??0)+1),v++;return{label:Dt(f),aliases:f,namePhrases:f.filter(Ot).filter(h=>h.includes(" ")||!d.has(Q(h))),aliasTokens:new Set(f.flatMap(h=>R(h))),priorityTokens:d,nameTokens:new Set(R(f[0]??"")),sentences:b,tf:_,length:v}})}const qt=/^(tell me more|more|more please|go on|continue|keep going|say more|elaborate|expand|and\??|and then\??|what else\??|anything else\??|\.\.\.|…)$/,Vt=/^(yes|yeah|yep|yup|ya|sure|ok|okay|okie|mhm|please|pls|go ahead|do it|hit me|why not)$/,Yt=/\b(it|its|it's|that|this|they|them|those|these|the (app|project|tool|thing|system|paper|model|one|setup))\b/,Kt=/^(does|do|did|is|are|was|were|has|have|had|can|could|will|would)\b/,Jt=/\b(which|what|who|list|all|any|anything|every|everything|how many|uses?d?|using|built with|written in|made with|know[sn]?|familiar)\b/,Qt=new Set(["first","second","third","one","two","three","last","latter","former","next","other","previous","previou"]),Xt=["team","guid","develop","coordinator"],Zt=/\b(project|app|apps|tool|paper|research|thing|one|work)\b/;class en{chunks;idf=new Map;df=new Map;avgdl;allAliasTokens=new Set;vocab=[];topic=null;pending=null;offeredMore=!1;constructor(e){this.chunks=Wt(e);const t=this.chunks.length||1;let n=0;for(const i of this.chunks){n+=i.length;for(const s of new Set([...i.tf.keys(),...i.aliasTokens]))this.df.set(s,(this.df.get(s)??0)+1);for(const s of i.aliasTokens)this.allAliasTokens.add(s)}for(const[i,s]of this.df)this.idf.set(i,Math.log(1+(t-s+.5)/(s+.5)));this.avgdl=n/t;for(const[i,s]of this.idf)i.length>=4&&s>=.5&&this.vocab.push({token:i,idf:s})}async ask(e,t){const n=e.trim(),i=n.toLowerCase(),s=i.replace(/[!.?]+$/,"").trim(),a=tn(i);if(a)return{text:a,grounded:!0};if(this.pending){const u=this.resolveClarify(s);if(this.pending=null,u!=null)return this.answerFrom(this.chunks[u],u,[])}const r=this.offeredMore;this.offeredMore=!1;const c=ee(R(n));if((qt.test(s)||r&&Vt.test(s)||c.length===0)&&this.topic)return this.continueTopic();if(c.length===0)return this.reprompt();if(this.topic&&c.every(u=>Qt.has(u)))return this.continueTopic();const d=[],f=c.map(u=>{if(this.idf.has(u))return u;const E=this.correct(u);return E&&d.push(`reading "${u}" as "${E}"`),E??u}),b=O(n),_=this.tryCompound(n);if(_)return this.decorate(_,d);const v=this.rank(f,b),h=v[0],p=h!=null&&(h.phraseHit||h.bestIdf>=K||h.matched>=2&&h.idfSum>=Ct),g=f.some(u=>!Z.has(u)&&(this.idf.get(u)??0)>=K&&this.chunks.some(E=>E.nameTokens.has(u)))||this.chunks.some(u=>Bt(b,u)),k=/\bwho\b/.test(i)?Xt:[];if(Jt.test(i)){const u=this.tryAggregate(i,f);if(u)return this.decorate(u,d)}if(this.topic&&Yt.test(i)&&!g){const u=this.topic;return this.decorate(this.answerFrom(this.chunks[u.index],u.index,f,k),d)}if(p&&!h.phraseHit&&!g){const u=v[1];if(u&&u.index!==h.index&&u.score>=h.score*It&&u.matched>0&&Zt.test(i))return this.pending={options:[{index:h.index,label:h.chunk.label},{index:u.index,label:u.chunk.label}]},{text:`that could mean ${h.chunk.label} or ${u.chunk.label} — which one?`,grounded:!0}}if(p){const u=this.decorate(this.answerFrom(h.chunk,h.index,f,k),d),E=h.priorityTerm;if(E&&!g){const L=v.find(m=>m.index!==h.index&&(m.chunk.aliasTokens.has(E)||(m.chunk.tf.get(E)??0)>0));if(L){const m=i.split(/[^a-z0-9+#.]+/).filter(y=>y.length>1).find(y=>Q(y.replace(/^[.]+|[.]+$/g,""))===E)??E;u.text+=`

(${m} also comes up in ${L.chunk.label} — ask about ${L.chunk.label} if that's what you meant.)`}}return u}return Kt.test(s)?{text:`hmm, nothing in my notes about that, so i can't confirm either way. i can talk about: ${this.topicList()}.`,grounded:!1}:this.fallback()}rank(e,t){return this.chunks.map((n,i)=>this.scoreChunk(n,i,e,t)).sort((n,i)=>i.score-n.score)}scoreChunk(e,t,n,i){let s=0,a=0,r=0,c=0,l=null;for(const f of n){const b=this.idf.get(f)??0,_=e.tf.get(f)??0,v=_===0?0:_*(fe+1)/(_+fe*(1-ge+ge*(e.length/this.avgdl))),h=b*v,p=e.aliasTokens.has(f)?b*St:0,g=e.priorityTokens.has(f)?Nt:0;g>0&&(l=f),(h>0||p>0)&&(a++,c+=b,b>r&&(r=b)),s+=h+p+g}let d=!1;for(const f of e.namePhrases)N(i).includes(N(f))&&(s+=Lt,d=!0);return{chunk:e,index:t,score:s,matched:a,bestIdf:r,idfSum:c,phraseHit:d,priorityTerm:l}}correct(e){if(e.length<5)return null;const t=e.length>=7?2:1;let n=null;for(const i of this.vocab){if(i.token[0]!==e[0])continue;const s=$t(e,i.token,t);s>t||(!n||s<n.dist||s===n.dist&&i.idf>n.idf)&&(n={token:i.token,dist:s,idf:i.idf})}return n?.token??null}tryCompound(e){const t=e.split(/\s*(?:\band\b|\bvs\.?\b|\bversus\b|[;,&])\s*/i).map(r=>r.trim()).filter(r=>r.length>=3);if(t.length<2||t.length>3)return null;const n=[];for(const r of t){const c=ee(R(r)).map(d=>this.idf.has(d)?d:this.correct(d)??d);if(c.length===0)return null;const l=this.rank(c,O(r))[0];if(!l||!(l.phraseHit||l.bestIdf>=K))return null;n.push({part:r,r:l,terms:c})}if(new Set(n.map(r=>r.r.index)).size<2)return null;const s=[],a=[];for(const r of n){const c=this.answerFrom(r.r.chunk,r.r.index,r.terms);s.push(`${r.r.chunk.label}: ${c.text}`),a.push(r.r.chunk.label)}return this.offeredMore=!1,{text:s.join(`

`).replace(/ — say "more" for the rest\./g,""),grounded:!0,sources:a}}tryAggregate(e,t){let n=null;for(const r of t){const c=this.df.get(r)??0,l=this.idf.get(r)??0;c>=2&&c<=Rt&&l>=K&&!this.allAliasTokens.has(r)&&!Z.has(r)&&(!n||l>n.idf)&&(n={term:r,idf:l})}if(!n)return null;const i=e.split(/[^a-z0-9+#.]+/).filter(r=>r.length>1).find(r=>Q(r.replace(/^[.]+|[.]+$/g,""))===n.term)??n.term,s=this.chunks.map((r,c)=>({chunk:r,index:c,tf:r.tf.get(n.term)??0})).filter(r=>r.tf>0).sort((r,c)=>c.tf-r.tf).slice(0,Pt);if(s.length<2)return null;const a=s.map(r=>{const c=this.extract(r.chunk,[n.term]).slice(0,1),l=c.length>0?r.chunk.sentences[c[0]].text:"";return`${r.chunk.label}: ${l}`});return this.topic=null,{text:`${i} shows up in ${s.length} of my notes —

${a.join(`

`)}`,grounded:!0,sources:s.map(r=>r.chunk.label)}}resolveClarify(e){const t=this.pending.options,n=N(O(e));for(const i of t)if(n.includes(N(O(i.label))))return i.index;return/\b(first|former|1st|1)\b/.test(e)?t[0].index:/\b(second|latter|2nd|2)\b/.test(e)?t[1]?.index??null:/\b(both|either|all)\b/.test(e)?t[0].index:null}decorate(e,t){return t.length===0||!e.grounded?e:{...e,text:`(${t.join(", ")}) ${e.text}`}}answerFrom(e,t,n,i=[]){const s=[...n.filter(l=>!e.nameTokens.has(l)&&!Z.has(l)&&(this.idf.get(l)??0)>=xt),...i];if(s.length>0){const l=this.extract(e,s);if(l.length>0)return this.topic={index:t,shown:new Set(l)},{text:l.map(d=>e.sentences[d].text).join(" "),grounded:!0,sources:[e.label]}}const a=e.sentences.slice(0,Mt),r=new Set(a.map((l,d)=>d));this.topic={index:t,shown:r};let c=a.map(l=>l.text).join(" ");return e.sentences.length>a.length&&(c+=' — say "more" for the rest.',this.offeredMore=!0),{text:c,grounded:!0,sources:[e.label]}}extract(e,t){const i=e.sentences.map((s,a)=>{let r=0;for(const c of t)s.terms.has(c)&&(r+=this.idf.get(c)??.5);return{i:a,sc:r}}).filter(s=>s.sc>0).sort((s,a)=>a.sc-s.sc).slice(0,At).sort((s,a)=>s.i-a.i).map(s=>s.i);if(i.length===1){const s=i[0],a=e.sentences[s+1];a&&e.sentences[s].text.length+a.text.length<380&&/^(it|its|this|that|the |so |which |and )/i.test(a.text)&&i.push(s+1)}return i}continueTopic(){const e=this.topic,t=this.chunks[e.index],n=[];for(let a=0;a<t.sentences.length;a++)e.shown.has(a)||n.push(a);if(n.length===0)return{text:`that's everything in my notes on ${t.label}. ask me something specific — its stack, how it works, who's involved.`,grounded:!0,sources:[t.label]};const i=n.slice(0,Tt);i.forEach(a=>e.shown.add(a));let s=i.map(a=>t.sentences[a].text).join(" ");return e.shown.size<t.sentences.length&&(s+=" — more?",this.offeredMore=!0),{text:s,grounded:!0,sources:[t.label]}}reprompt(){return{text:`ask me something about nafees — try: ${this.topicList()}.`,grounded:!1}}fallback(){return{text:`hmm, that's not in my notes. i can talk about: ${this.topicList()}.`,grounded:!1}}topicList(){return this.chunks.slice(0,8).map(e=>e.label).join(", ")}}function tn(o){const e=o.replace(/[!.?]+$/,"").trim();return/^(hi|hey|hello|yo|sup|howdy|hiya|heya|hii+|hey there|good (morning|evening|afternoon))\b/.test(e)?`hey! i'm liffy — nafees's terminal sidekick. ask me anything about him. try: "what does he build?"`:/^(thanks|thank you|thx|ty|tysm|appreciate it|cheers|nice|cool|awesome|great)\b/.test(e)?"anytime :)":/^(wow+|woah|whoa|nice+|cool+|lol|lmao|haha+|hehe+|damn|based)\b/.test(e)?"right? ask me more.":/^(bye|cya|goodbye|see ya|see you|later|gtg|good night|gn)\b/.test(e)?"catch you later! (close the window whenever)":/\b(how are you|how's it going|hows it going|you good|wyd)\b/.test(e)?"just vibing in the terminal, waiting for questions about nafees. what do you want to know?":/(are|r) you (a )?(bot|ai|robot|real|human|person|chatgpt|claude)/.test(e)?"i'm a lil retrieval bot — no LLM, no keys. i only know what's in nafees's notes, and i answer straight from them.":/\byour (favorite|favourite|fav|opinion|thoughts?)\b/.test(e)?"i deal in facts from nafees's notes, not opinions. though between us — the cat is objectively the best part of this site.":/\b(tell|know|got|have).*(joke|something funny)\b|^joke$/.test(e)?"a chatbot with no LLM walks into a bar. that's it. that's me. i'm the joke. ask me about nafees instead.":/(who|what) are you|your name|are you liffy(?!\s*(review|the))/.test(e)?"i'm liffy, a tiny assistant that knows nafees. ask away — projects, skills, research, contact, whatever.":/^(help|what can you do|commands|options|menu|\?)$/.test(e)?'i answer questions about nafees from his notes. try: "what does he build?", "tell me about askcal", "which projects use fastapi?", or just a topic name.':/(who (made|built|created) you)/.test(e)?"nafees built me for this site — a grounded retriever over his own notes. ask me about him next.":null}const nn=`# Liffy's notes on Nafees
...
`;let sn=null;const on=()=>sn??=new en(nn),an=`hey, i'm liffy — nafees's lil terminal sidekick. ask me anything about him. try: "what does he build?"`,rn=/^me+o+w+[\s.!?~]*$/i,ln=/\b(cookie|treat)\b/i,ye="meow. mrrp. purrrr. (translation: hi. i like you. bring snacks.)";function Te(o){const e=on(),t=[];let n=!1;const i=document.createElement("div");i.className="liffy";const s=document.createElement("div");s.className="liffy__log u-fade-cat",s.setAttribute("role","log"),s.setAttribute("aria-live","polite");const a=document.createElement("form");a.className="liffy__inputrow";const r=document.createElement("span");r.className="liffy__prompt",r.textContent="you>";const c=document.createElement("input");c.className="liffy__input",c.type="text",c.setAttribute("aria-label","ask liffy"),c.autocomplete="off",c.autocapitalize="off",c.spellcheck=!1,c.setAttribute("autocorrect","off"),c.setAttribute("enterkeyhint","go"),a.append(r,c),i.append(s,a),s.addEventListener("click",()=>{(window.getSelection()?.toString()??"")===""&&c.focus()});const l=()=>{s.scrollTop=s.scrollHeight},d=(g,k)=>{const u=document.createElement("div");u.className="liffy__line";const E=document.createElement("span");E.className=`liffy__who ${k}`,E.textContent=g;const L=document.createElement("span");return L.className="liffy__text",u.append(E,L),s.append(u),l(),L},f=async g=>{const k=d("liffy>","liffy__who--bot");if(M())k.textContent=g;else{const u=g.length>320?4:g.length>160?6:9;await te(k,g,{speed:u})}l()},b=["thinking","pondering","purring","consulting the cat","rummaging through notes","recalling"];let _=0;const v=async g=>{if(n)return;if(n=!0,c.disabled=!0,d("you>","liffy__who--user").textContent=g,t.push({role:"user",text:g}),rn.test(g)){const y=d("","liffy__who--bot");y.classList.add("liffy__thinking"),y.textContent="✳ thought for 0.0s (instinct)",t.push({role:"liffy",text:ye}),p.hop(),await f(ye),n=!1,c.disabled=!1,c.focus();return}const k=d("","liffy__who--bot");k.classList.add("liffy__thinking");const u=we(k,b[_++%b.length]);p.think(!0),M()||await P(650+Math.random()*750);const E=await e.ask(g,t),L=u.stop();p.think(!1);const m=E.sources?.length?` · read notes: ${E.sources.join(", ")}`:"";k.textContent=`✳ thought for ${Math.max(L,.1).toFixed(1)}s${m}`,t.push({role:"liffy",text:E.text}),p.bob(!0),await f(E.text),p.bob(!1),n=!1,c.disabled=!1,c.focus()};a.addEventListener("submit",g=>{g.preventDefault();const k=c.value.trim();!k||n||(c.value="",p.onSend(),v(k))});const h=o.windows.open({id:"liffy",title:"liffy — ask about nafees",content:i,width:520,height:420});h.bodyEl.style.padding="0";const p=new ke({mount:i,mode:"liffy",idleFrame:"awake"});c.addEventListener("input",()=>{const g=c.value;ln.test(g)?p.fillNow():p.onTyping(g.length)}),f(an),c.focus(),o.terminal.print("opened: liffy","dim")}const cn=`# Nafees S — résumé
...
---`;function Ae(o){const e=document.createElement("div");e.className="docs",e.innerHTML=Ee(cn);const t="/preview-ed92ce9f0775fa2d410c/resume.pdf";fetch(t,{method:"HEAD"}).then(n=>{const i=n.headers.get("content-type")??"";if(!n.ok||!i.includes("pdf"))return;const s=document.createElement("div");s.className="docs__toolbar";const a=document.createElement("a");a.className="docs__download",a.href=t,a.target="_blank",a.rel="noreferrer noopener",a.textContent="↓ download PDF",s.append(a),e.prepend(s)}).catch(()=>{}),o.windows.open({id:"resume",title:"resume — nafees",content:e,width:560,height:480}),o.terminal.print("opened: resume","dim")}function z(o,e){return async t=>{if(M()){e(t);return}const n=document.createElement("div");n.className="terminal__line terminal__line--sub",t.terminal.printEl(n);const i=we(n,o);await P(320+Math.random()*260),i.stop(),n.remove(),e(t)}}function dn(){const o=[],e=t=>{t.terminal.print("available commands:");for(const n of o.filter(i=>!i.hidden)){const i=(n.usage??n.name).padEnd(18);t.terminal.print(`  ${i}${n.summary}`,"dim")}};return o.push({name:"help",summary:"list available commands",run:e},{name:"about",summary:"who is lucenity",run:z("waking about",_e)},{name:"resume",summary:"view my résumé",run:z("dusting off the résumé",Ae)},{name:"projects",summary:"browse my work",run:z("indexing projects",xe)},{name:"project",summary:"open a specific project",usage:"project <slug>",run:async t=>{const n=t.args[0];if(!n){t.terminal.print("usage: project <slug>","dim"),t.terminal.print(`slugs: ${A.map(i=>i.slug).join(", ")}`,"sub");return}await z(`spinning up ${n}`,i=>Le(i,n))(t)},complete:t=>t.length>1?[]:A.map(n=>n.slug)},{name:"contact",summary:"how to reach me",run:z("opening channels",Se)},{name:"liffy",summary:"chat with liffy, my lil assistant",run:z("poking liffy awake",Te)},{name:"clear",summary:"clear the screen",run:t=>t.terminal.clear()},{name:"whoami",summary:"print the current session identity",run:t=>t.terminal.print("visitor@lucenity — guest session","dim")},{name:"cat",summary:"",hidden:!0,run:t=>{const n=ne("cat terminal__cat");t.terminal.printEl(n),t.terminal.print("the cat is asleep. it is always asleep. =^..^=","dim")}},{name:"sudo",summary:"",hidden:!0,run:t=>t.terminal.print("nice try. you're a guest here :)","dim")},{name:"git",usage:"git <subcommand>",summary:"",hidden:!0,run:t=>{const n=t.args[0];if(!n){t.terminal.print("usage: git <subcommand>","dim"),t.terminal.print("subcommands: init, clone","sub");return}if(n==="init")t.terminal.print("Nafees's Github! : https://github.com/lucenity0","dim");else if(n==="clone"){const i=t.args[1];if(!i){t.terminal.print("usage: git clone <slug>","dim"),t.terminal.print(`slugs: ${A.map(a=>a.slug).join(", ")}`,"sub");return}if(!A.find(a=>a.slug===i)){t.terminal.print(`error: no project found with slug '${i}'`,"dim"),t.terminal.print(`valid slugs: ${A.map(a=>a.slug).join(", ")}`,"sub");return}t.terminal.print(`Cloning into '${i}'...`,"dim"),t.terminal.print(`remote: https://github.com/lucenity0/${i}.git`,"sub")}},complete:t=>t.length<=1?["init","clone"]:t[0]==="clone"&&t.length===2?A.map(n=>n.slug):[]}),o}const j=5,hn=42,S={bright:"#f4f4f4",light:"#c8c8c8",mid:"#808080",dim:"#9a9a9a",far:"#3a3a3a",shadow:"#222222",ground:"#121212",groundLine:"#2a2a2a",liquid:"#1a1a1a"},un=["###","..#",".#.","#..","###"];function mn(o){const e=document.createElement("canvas");e.className="gui__wallpaper",e.setAttribute("aria-hidden","true"),o.append(e);const t=e.getContext("2d"),n=M();let i=0,s=0,a=[],r=[],c=0;const l=(v,h,p,g,k)=>{t.fillStyle=k,t.fillRect(Math.round(v),Math.round(h),Math.round(p),Math.round(g))},d=(v,h,p,g)=>{t.globalAlpha=Math.max(0,Math.min(1,g));for(let k=0;k<5;k++)for(let u=0;u<3;u++)un[k][u]==="#"&&l(v+u*p,h+k*p,p,p,S.light);t.globalAlpha=1},f=()=>{const v=o.clientWidth||1,h=o.clientHeight||1;i=Math.ceil(v/j),s=Math.ceil(h/j),e.width=i,e.height=s,e.style.width=`${i*j}px`,e.style.height=`${s*j}px`;let p=1337;const g=()=>(p=p*1103515245+12345&2147483647)/2147483647;a=[];const k=Math.max(10,Math.floor(s*.55)),u=Math.floor(i*k/260);for(let E=0;E<u;E++){const L=2+Math.floor(g()*(i-4)),m=2+Math.floor(g()*k);L>i-34&&m<24||a.push({x:L,y:m,ph:g()*Math.PI*2,sp:.6+g()*1.6,big:g()>.86})}r=[];for(let E=1;E<i;E+=2+Math.floor(g()*3))r.push({x:E,h:2+Math.floor(g()*3),ph:g()*Math.PI*2})},b=v=>{t.clearRect(0,0,i,s);const h=s-Math.ceil(hn/j)-10;for(const w of a){const C=n?.8:.45+.55*Math.sin(v*.002*w.sp+w.ph);if(C<.28)continue;const x=C>.8?S.bright:C>.55?S.light:S.mid;l(w.x,w.y,1,1,x),w.big&&C>.7&&(l(w.x-1,w.y,1,1,S.mid),l(w.x+1,w.y,1,1,S.mid),l(w.x,w.y-1,1,1,S.mid),l(w.x,w.y+1,1,1,S.mid))}const p=i-20,g=14,k=8;t.fillStyle=S.dim,t.beginPath(),t.arc(p,g,k,0,Math.PI*2),t.fill(),t.globalCompositeOperation="destination-out",t.beginPath(),t.arc(p+3.4,g-1.6,k,0,Math.PI*2),t.fill(),t.globalCompositeOperation="source-over",l(p-4,g+2,1,1,S.mid),l(p-6,g-2,1,1,S.mid),l(0,h,i,s-h,S.ground),l(0,h,i,1,S.groundLine);for(let w=3;w<i;w+=11)l(w,h+4+w*7%5,1,1,S.far);for(const w of r){const C=n?0:Math.round(Math.sin(v*.0016+w.ph)*.6);l(w.x+C,h-w.h,1,w.h,w.h>3?S.far:S.shadow),l(w.x,h-1,1,1,S.far)}const u=Math.max(6,Math.floor(i*.16)),E=n?0:Math.sin(v*.0022)>.3?-1:0,L=h-H.length+3+E;l(u+3,h+2,17,1,S.shadow);for(let w=0;w<H.length;w++){const C=H[w];for(let x=0;x<C.length;x++)C[x]==="#"&&l(u+x,L+w,1,1,S.light)}if(n)d(u+11,L-5,2,.9);else for(let C=0;C<3;C++){const x=(v+C*860)%2600/2600,X=x<.18?x/.18:x>.7?(1-x)/.3:1;d(u+9+x*6,L-1-x*16,1+(C>1?1:0),X)}const m=u+H[0].length+6,y=h-6;if(l(m,y,7,6,S.light),l(m+6,y+1,1,4,S.mid),l(m+7,y+1,2,1,S.mid),l(m+8,y+2,1,2,S.mid),l(m+7,y+4,2,1,S.mid),l(m+1,y,5,1,S.liquid),l(m+1,y+6,6,1,S.shadow),n)l(m+2,y-3,1,1,S.mid),l(m+5,y-5,1,1,S.mid);else{for(let w=0;w<2;w++){const C=m+2+w*3;for(let x=0;x<4;x++){const X=((v*.0012+w*.4+x*.25)%1+1)%1,Pe=x===0?.5:.5-X*.4;t.globalAlpha=Math.max(.08,Pe),l(C+Math.round(Math.sin(v*.003+x+w)*1),y-2-x*2,1,1,S.mid)}}t.globalAlpha=1}};if(f(),n)b(1800);else{const v=performance.now(),h=p=>{b(p-v),c=requestAnimationFrame(h)};c=requestAnimationFrame(h)}const _=new ResizeObserver(()=>{f(),n&&b(1800)});return _.observe(o),{destroy(){cancelAnimationFrame(c),_.disconnect(),e.remove()}}}function pn(o,e,t){const n=document.createElement("div");n.className="gui";const i=mn(n),s=[{id:"about",label:"about.txt",glyph:"≡",kind:"file",open:_e},{id:"projects",label:"projects",glyph:"",kind:"folder",open:xe},{id:"resume",label:"resume.pdf",glyph:"PDF",kind:"file",open:Ae},{id:"liffy",label:"liffy",glyph:"=^..^=",kind:"app",open:Te},{id:"contact",label:"contact",glyph:"@",kind:"file",open:Se},{id:"tty",label:"terminal",glyph:">_",kind:"sys",open:()=>t.set("tty")}],a=document.createElement("div");a.className="gui__icons";for(const m of s){const y=document.createElement("button");y.type="button",y.className=`gui__icon gui__icon--${m.kind}`;const w=document.createElement("span");w.className="gui__icon-art",w.textContent=m.glyph;const C=document.createElement("span");C.className="gui__icon-label",C.textContent=m.label,y.append(w,C),y.addEventListener("click",()=>m.open(e)),a.append(y)}const r=document.createElement("div");r.className="gui__taskbar";const c=document.createElement("button");c.type="button",c.className="gui__start",c.textContent="⌂ lucenity",c.setAttribute("aria-haspopup","true"),c.setAttribute("aria-expanded","false");const l=document.createElement("div");l.className="gui__menu",l.hidden=!0;for(const m of s){const y=document.createElement("button");y.type="button",y.className="gui__menu-item",y.textContent=m.label,y.addEventListener("click",()=>{d(),m.open(e)}),l.append(y)}const d=()=>{l.hidden=!0,c.setAttribute("aria-expanded","false")};c.addEventListener("click",m=>{m.stopPropagation(),l.hidden=!l.hidden,c.setAttribute("aria-expanded",String(!l.hidden))});const f=m=>{!l.hidden&&!l.contains(m.target)&&d()};document.addEventListener("click",f);const b=document.createElement("div");b.className="gui__tasks";const _=document.createElement("div");_.className="gui__tray";const v=document.createElement("span");v.className="gui__tray-cat",v.textContent="=^..^=",v.title="the cat is asleep. it is always asleep.";const h=document.createElement("span");h.className="gui__clock";const p=()=>{const m=new Date;h.textContent=`${String(m.getHours()).padStart(2,"0")}:${String(m.getMinutes()).padStart(2,"0")}`};p();const g=window.setInterval(p,15e3);_.append(v,h),r.append(c,b,_),n.append(a,l,r),o.append(n);const k=()=>{b.textContent="";for(const m of e.windows.list()){const y=document.createElement("button");y.type="button",y.className="gui__task",m.minimized?y.classList.add("is-min"):m.el.classList.contains("is-active")&&y.classList.add("is-on"),y.textContent=m.title,y.title=m.minimized?`restore ${m.title}`:m.title,y.addEventListener("click",()=>{m.minimized?e.windows.restore(m.id):m.el.classList.contains("is-active")?e.windows.minimize(m.id):e.windows.focus(m.id)}),b.append(y)}};let u=0;const E=()=>{cancelAnimationFrame(u),u=requestAnimationFrame(k)},L=new MutationObserver(m=>{m.every(y=>n.contains(y.target))||E()});return L.observe(o,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]}),k(),{destroy(){L.disconnect(),cancelAnimationFrame(u),window.clearInterval(g),document.removeEventListener("click",f),i.destroy(),n.remove()}}}const W=document.getElementById("app");if(!W)throw new Error("#app mount element not found");pt();const Ie=new Be(W),se=new Re;se.registerAll(dn());const B=new qe(W,se,Ie),D=new ut,fn={terminal:B,windows:Ie,args:[],flags:{},raw:""};let G=null;const Ne=()=>{D.current==="gui"&&!G?G=pn(W,fn,D):D.current==="tty"&&G&&(G.destroy(),G=null,B.focusInput())};D.onChange(Ne);Ne();se.register({name:"gui",summary:"switch to the GUI desktop",run:o=>{o.terminal.print("switching to gui — the toggle brings you back.","dim"),D.set("gui")}});Ke(B).then(()=>{const o=ht(W);B.onTyping=e=>o.companion.onTyping(e),B.onSend=()=>o.companion.onSend(),B.onClear=()=>o.restore()});
//# sourceMappingURL=index-BcQoT5m_.js.map
